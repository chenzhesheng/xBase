 ...
 */
package com.chenzhesheng.xBase.demo.mvp.ui.holder;
...
public class UserItemHolder extends BaseHolder<User> {
    ...
    /**
     * 在 Activity 的 onDestroy 中使用 {@link DefaultAdapter#Companion#releaseAllHolder(RecyclerView)} 方法 (super.onDestroy() 之前)
