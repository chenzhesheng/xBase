 ...
 */
package com.chenzhesheng.xBase.demo.mvp.model;

import android.arch.lifecycle.Lifecycle;
import android.arch.lifecycle.OnLifecycleEvent;

import com.chenzhesheng.xBase.demo.mvp.contract.UserContract;
import com.chenzhesheng.xBase.demo.mvp.model.api.cache.CommonCache;
import com.chenzhesheng.xBase.demo.mvp.model.api.service.UserService;
...
import com.chenzhesheng.xBase.mvp.BaseModel;
...
public class UserModel extends BaseModel implements UserContract.Model {
    ...
    public Observable<List<User>> getUsers(int lastIdQueried, boolean update) {
        ...
        return Observable.just(getMRepositoryManager()
                ...
                .flatMap(new Function<Observable<List<User>>, ObservableSource<List<User>>>() {
                    ...
                    public ObservableSource<List<User>> apply(@NonNull Observable<List<User>> listObservable) throws Exception {
                        return getMRepositoryManager().obtainCacheService(CommonCache.class)
