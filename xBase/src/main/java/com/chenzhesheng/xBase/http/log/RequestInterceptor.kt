...
import com.chenzhesheng.xBase.utils.CharacterHandler
import com.chenzhesheng.xBase.utils.UrlEncoderUtils
import com.chenzhesheng.xBase.utils.ZipHelper
import okhttp3.*
import okio.Buffer
 ...
 */
@Singleton
open class RequestInterceptor @Inject constructor() : Interceptor {
    @Inject
    @JvmField
    var mHandler: GlobalHttpHandler? = null
    @Inject
    @JvmField
    var mPrinter: FormatPrinter? = null
    @Inject
    @JvmField
